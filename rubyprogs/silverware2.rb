...
def code  #verifies combination for drawer
     1234
end
...
#BONUS SECTION
puts fork.clean #=> should  return false 

fork.clean_silverware #=> should clean the fork
fork.polish #=> should polish the fork
fork.condition #=> should return clean and polished
silverware_drawer.lock #=> should lock drawer
silverware_drawer.open #=> should indicate that drawer cannot be open
silverware_drawer.unlock(1234) #=> should unlock drawer
